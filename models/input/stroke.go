...
type Stroke struct {
	...
	mouseDownTargets []interfaces.EventOwner

	targetObject interfaces.EventOwner
}
...
// Target ...
func (s *Stroke) Target() (interfaces.EventOwner, bool) {
	t := s.targetObject
	return t, t != nil
}
...
// MouseDownTargets ...
func (s *Stroke) MouseDownTargets() []interfaces.EventOwner {
	return s.mouseDownTargets
}

// SetMouseDownTargets ...
func (s *Stroke) SetMouseDownTargets(targets []interfaces.EventOwner) {
