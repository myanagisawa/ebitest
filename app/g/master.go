...
// NewMSite ...
func NewMSite(code string, t enum.SiteTypeEnum, name string, loc *Point) *MSite {
...
// LoadSites ...
func LoadSites() []MSite {
	return []MSite{
		*NewMSite("site-1", enum.SiteTypeBase, "base-1", NewPoint(0.318, 0.707)),
		*NewMSite("site-2", enum.SiteTypeBase, "base-2", NewPoint(0.161, 0.761)),
		*NewMSite("site-3", enum.SiteTypeBase, "base-3", NewPoint(0.237, 0.826)),
		*NewMSite("site-4", enum.SiteTypeBase, "base-4", NewPoint(0.345, 0.847)),
		*NewMSite("site-5", enum.SiteTypeBase, "base-5", NewPoint(0.255, 0.883)),
		*NewMSite("site-6", enum.SiteTypeBase, "base-6", NewPoint(0.573, 0.780)),
		*NewMSite("site-7", enum.SiteTypeCity, "city-1", NewPoint(0.306, 0.623)),
		*NewMSite("site-8", enum.SiteTypeCity, "city-2", NewPoint(0.302, 0.663)),
		*NewMSite("site-9", enum.SiteTypeCity, "city-3", NewPoint(0.295, 0.726)),
		*NewMSite("site-10", enum.SiteTypeCity, "city-4", NewPoint(0.276, 0.751)),
		*NewMSite("site-11", enum.SiteTypeCity, "city-5", NewPoint(0.181, 0.648)),
		*NewMSite("site-12", enum.SiteTypeCity, "city-6", NewPoint(0.181, 0.598)),
		*NewMSite("site-13", enum.SiteTypeCity, "city-7", NewPoint(0.120, 0.847)),
		*NewMSite("site-14", enum.SiteTypeCity, "city-8", NewPoint(0.193, 0.863)),
		*NewMSite("site-15", enum.SiteTypeCity, "city-9", NewPoint(0.263, 0.953)),
		*NewMSite("site-16", enum.SiteTypeCity, "city-10", NewPoint(0.279, 0.842)),
		*NewMSite("site-17", enum.SiteTypeCity, "city-11", NewPoint(0.314, 0.893)),
		*NewMSite("site-18", enum.SiteTypeCity, "city-12", NewPoint(0.374, 0.835)),
		*NewMSite("site-19", enum.SiteTypeCity, "city-13", NewPoint(0.378, 0.932)),
		*NewMSite("site-20", enum.SiteTypeCity, "city-14", NewPoint(0.448, 0.863)),
		*NewMSite("site-21", enum.SiteTypeCity, "city-15", NewPoint(0.479, 0.824)),
		*NewMSite("site-22", enum.SiteTypeCity, "city-16", NewPoint(0.563, 0.852)),
		*NewMSite("site-23", enum.SiteTypeCity, "city-17", NewPoint(0.565, 0.708)),
		*NewMSite("site-24", enum.SiteTypeCity, "city-18", NewPoint(0.600, 0.613)),
		*NewMSite("site-25", enum.SiteTypeCity, "city-19", NewPoint(0.652, 0.856)),
		*NewMSite("site-26", enum.SiteTypeCity, "city-20", NewPoint(0.698, 0.805)),
		*NewMSite("site-27", enum.SiteTypeFort, "fort-1", NewPoint(0.181, 0.718)),
		*NewMSite("site-28", enum.SiteTypeFort, "fort-2", NewPoint(0.189, 0.785)),
		*NewMSite("site-29", enum.SiteTypeFort, "fort-3", NewPoint(0.252, 0.801)),
		*NewMSite("site-30", enum.SiteTypeFort, "fort-4", NewPoint(0.413, 0.834)),
		*NewMSite("site-31", enum.SiteTypePoint, "point-1", NewPoint(0.245, 0.714)),
		*NewMSite("site-32", enum.SiteTypePoint, "point-2", NewPoint(0.209, 0.822)),
		*NewMSite("site-33", enum.SiteTypePoint, "point-3", NewPoint(0.230, 0.868)),
		*NewMSite("site-34", enum.SiteTypePoint, "point-4", NewPoint(0.302, 0.807)),
		*NewMSite("site-35", enum.SiteTypePoint, "point-5", NewPoint(0.484, 0.918)),
		*NewMSite("site-36", enum.SiteTypePoint, "point-6", NewPoint(0.566, 0.751)),
		*NewMSite("site-37", enum.SiteTypePoint, "point-7", NewPoint(0.580, 0.656)),
		*NewMSite("site-38", enum.SiteTypeRemains, "remains-1", NewPoint(0.127, 0.730)),
		*NewMSite("site-39", enum.SiteTypeRemains, "remains-2", NewPoint(0.223, 0.786)),
		*NewMSite("site-40", enum.SiteTypeRemains, "remains-3", NewPoint(0.580, 0.747)),
		*NewMSite("site-41", enum.SiteTypeRemains, "remains-4", NewPoint(0.636, 0.793)),
	}
}

// LoadRoutes ...
func LoadRoutes() []MRoute {
	return []MRoute{
